...
/**
  * @brief  Clears the TIM1抯 pending flags.
...
/**
  * @brief  Configures the TIM1抯 DMA interface.
...
/**
  * @brief  Enables or disables the TIM抯 DMA Requests.
...
/**
  * @brief  Enables or Disables the TIM抯 Hall sensor interface.
